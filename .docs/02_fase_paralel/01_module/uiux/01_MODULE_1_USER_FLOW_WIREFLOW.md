...
Dokumen ini mendefinisikan rancangan **User Flow** dan **Wireflow Sederhana** untuk **Modul 1: Navigasi Kurikulum** (UC-01, UC-02, UC-03) pada aplikasi **OpenCampus Mobile** berdasarkan spesifikasi pada [PRD.md](../../../00_fase/01_PRD.md), [USE_CASE.md](../../../01_fase/01_USE_CASE.md), dan [ACTIVITY_DIAGRAM.md](../../../01_fase/02_ACTIVITY_DIAGRAM.md).
...
### **Layar 1 — Beranda Semester ([UC-01](../../../01_fase/01_USE_CASE.md), [UC-09](../../../01_fase/01_USE_CASE.md))**
...
### **Layar 2 — Silabus Mata Kuliah ([UC-02](../../../01_fase/01_USE_CASE.md), [UC-03](../../../01_fase/01_USE_CASE.md))**
